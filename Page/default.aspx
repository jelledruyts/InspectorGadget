    ...
    protected void RenderDnsLookup()
    {
        ...
        <form method=""POST"" action=""#dns-lookup"">
            ...
            <div class=""form-group"">
                ...
                <input type=""text"" name=""dnsLookup"" id=""dnsLookup"" value=""" + HttpUtility.HtmlAttributeEncode(dnsLookup) + @""" class=""form-control"" title=""You can set the default value as a 'DefaultDnsLookupHost' configuration setting"" />
            </div>
            <div class=""form-group"">
    ...
    protected void RenderOutboundHttpRequest()
    {
        ...
        <form method=""POST"" action=""#outbound-http-request"">
            ...
            <div class=""form-group"">
                ...
                <input type=""text"" name=""requestUrl"" id=""requestUrl"" value=""" + HttpUtility.HtmlAttributeEncode(requestUrl) + @""" class=""form-control"" title=""You can set the default value as a 'DefaultHttpRequestUrl' configuration setting"" />
            </div>
            <div class=""form-group"">
                <label for=""requestHostName"">Override Host Name (optional)</label>
                <input type=""text"" name=""requestHostName"" id=""requestHostName"" value=""" + HttpUtility.HtmlAttributeEncode(requestHostName) + @""" class=""form-control"" title=""You can set the default value as a 'DefaultHttpRequestHostName' configuration setting"" />
            </div>
            <div class=""form-group"">
...
");
    ...
    protected void RenderOutboundSqlConnection()
    {
        ...
        var sqlQuery = Request["sqlQuery"] ?? ConfigurationManager.AppSettings["DefaultSqlConnectionSqlQuery"] ?? "SELECT 'User \"' + USER_NAME() + '\" logged in from IP address \"' + CAST(CONNECTIONPROPERTY('client_net_address') AS NVARCHAR) + '\" to database \"' + DB_NAME() + '\" on server \"' + @@SERVERNAME + '\"'";
        ...
        <form method=""POST"" action=""#outbound-sql-connection"">
            ...
            <div class=""form-group"">
                ...
                <input type=""password"" name=""sqlConnectionString"" id=""sqlConnectionString"" value=""" + HttpUtility.HtmlAttributeEncode(sqlConnectionString) + @""" class=""form-control"" autocomplete=""off"" title=""You can set the default value as a 'DefaultSqlConnectionSqlConnectionString' configuration setting"" />
            </div>
            <div class=""form-group"">
                <label for=""sqlQuery"">Query</label>
                <input type=""text"" name=""sqlQuery"" id=""sqlQuery"" value=""" + HttpUtility.HtmlAttributeEncode(sqlQuery) + @""" class=""form-control"" title=""You can set the default value as a 'DefaultSqlConnectionSqlQuery' configuration setting"" />
            </div>
            <div class=""form-group"">
    ...
    protected void RenderAzureManagedIdentity()
    {
        ...
        <form method=""POST"" action=""#azure-managed-identity"">
            ...
            <div class=""form-group"">
                ...
                <input type=""text"" name=""resource"" id=""resource"" value=""" + HttpUtility.HtmlAttributeEncode(resource) + @""" class=""form-control"" title=""You can set the default value as a 'DefaultAzureManagedIdentityResource' configuration setting"" />
            </div>
            <div class=""form-group"">
