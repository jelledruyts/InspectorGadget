...
| POST   | `/api/spiffe`                     | `workloadApiAddress`, `unixDomainSocketEndpoint`, `audience`                                                                                                                                 |
...
| `DefaultSpiffeWorkloadApiAddress`                  | SPIFFE                 | The default value for the Workload API address                                                                                  |
